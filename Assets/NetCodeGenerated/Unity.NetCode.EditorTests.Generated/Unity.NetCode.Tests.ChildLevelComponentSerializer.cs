...
{
    [BurstCompile]
    public struct UnityNetCodeTestsChildLevelComponentGhostComponentSerializer
    {
        static UnityNetCodeTestsChildLevelComponentGhostComponentSerializer()
        {
            State = new GhostComponentSerializer.State
            {
                GhostFieldsHash = 14767913548786401661,
                ExcludeFromComponentCollectionHash = 1,
                ComponentType = ComponentType.ReadWrite<Unity.NetCode.Tests.ChildLevelComponent>(),
                ComponentSize = UnsafeUtility.SizeOf<Unity.NetCode.Tests.ChildLevelComponent>(),
        ...
        private static void CopyToSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                ref var component = ref GhostComponentSerializer.TypeCast<Unity.NetCode.Tests.ChildLevelComponent>(componentData, componentStride*i);
        ...
        {
            ref var component = ref GhostComponentSerializer.TypeCast<Unity.NetCode.Tests.ChildLevelComponent>(componentData, 0);
            ref var backup = ref GhostComponentSerializer.TypeCast<Unity.NetCode.Tests.ChildLevelComponent>(backupData, 0);
